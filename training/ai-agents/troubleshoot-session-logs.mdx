...
In Cortana, session logs are conveniently located within each conversation thread. They are presented in a timeline format, appearing between the messages exchanged between the contact and the AI agent.
