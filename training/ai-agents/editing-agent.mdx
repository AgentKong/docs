...
Once your AI agent is live and interacting with contacts, you'll gather valuable insights into its performance. You may find that people ask unexpected questions or that you want to adjust the conversation's flow. Cortana provides powerful and flexible tools to make these adjustments. This guide will cover the two primary methods for editing your agent: training its knowledge base and modifying the conversational flow.
